...
def fig_nat_map():
    ISO3 = {'Spain':'ESP','France':'FRA','Italy':'ITA','Germany':'DEU','England':'GBR',
            'Brazil':'BRA','Argentina':'ARG','Netherlands':'NLD','Portugal':'PRT',
            'Senegal':'SEN','Belgium':'BEL','Denmark':'DNK','Serbia':'SRB',
            'Ivory Coast':'CIV','Switzerland':'CHE','Morocco':'MAR','Croatia':'HRV',
            'Uruguay':'URY','Austria':'AUT','Poland':'POL','Ghana':'GHA','Cameroon':'CMR',
            'Nigeria':'NGA','Sweden':'SWE','Algeria':'DZA','Mali':'MLI',
            'United States':'USA','Colombia':'COL','Norway':'NOR','Ireland':'IRL'}
...
def fig_xg_trend():
    ...
    fig.update_xaxes(title_text='Season', tickangle=-30, title_font_size=11)
...
navbar = html.Div([
    html.Div([
        ...
        html.Div([
            html.Div('Football Analytics Dashboard',
